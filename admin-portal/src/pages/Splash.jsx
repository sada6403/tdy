...
const Splash = () => {
  ...
  const [phase, setPhase] = useState(0); // 0=entering, 1=loaded, 2=exiting
  ...
  // Once auth check is done AND progress bar is near full, navigate
  useEffect(() => {
    if (!authLoading && progress >= 90) {
      setPhase(2);
      const timer = setTimeout(() => navigate(user ? '/' : '/login', { replace: true }), 400);
      return () => clearTimeout(timer);
    }
  }, [authLoading, progress, user, navigate]);
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        <div style={{ textAlign: 'center', marginBottom: '12px' }}>
          ...
          <p style={{
            ...
            color: 'rgba(16,185,129,0.8)', textTransform: 'uppercase', marginTop: '6px',
          }}>
            (PVT) LTD
          </p>
        </div>
        ...
        {/* Divider line */}
        <div style={{
          width: '200px', height: '1px', marginBottom: '16px',
        ...
        <div style={{
          ...
          <span style={{
            ...
            color: 'rgba(16,185,129,0.9)', textTransform: 'uppercase',
          }}>
            Admin Portal
          </span>
        </div>
        ...
        <div style={{ width: '280px', textAlign: 'center' }}>
          ...
          <p style={{
            ...
            {progress < 40 ? 'Initializing system...' : progress < 75 ? 'Loading modules...' : progress < 95 ? 'Verifying security...' : 'Ready'}
          </p>
        </div>
      </div>
      ...
      <div style={{
        ...
        <p style={{ fontSize: '11px', color: 'rgba(255,255,255,0.4)', letterSpacing: '2px', fontWeight: '600', margin: 0 }}>
